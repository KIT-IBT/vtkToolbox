...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    const std::string syntax = "outStruct = vtkConnectivityFilter(inStruct)";
    if(nrhs < 1)
    ...
    connectivityFilter->SetInputData(pointSet);
    ...
    plhs[0] = vtkToStruct(connectivityFilter->GetOutput(), false);
}
